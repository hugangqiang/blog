    ...
    Pagings.prototype = {
        ...
        bindEvents: function() {
		    ...
		    if(getQueryString('page') == null ){
		    	lis.removeClass('sel-page').eq(0).addClass('sel-page');
		    }else{
		    	lis.removeClass('sel-page').eq(getQueryString('page') - 1).addClass('sel-page');
		    }
            
            //handles(that.options.pageNo); // 初始化页码位置
        }
    }
    $.fn.pagings = function(options) {
        return new Pagings($(this), options);
    }
})(jQuery, window, document);